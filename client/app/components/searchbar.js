    ...
    return (
      <div className="uthrift-navbar-search col-md-8" id="navSearch" >
        <form role="search" className="col-md-12" id = "searchForm">
          ...
          <input className="uthrift-navbar-input col-md-8"  type="text" placeholder="Search UThrift..." name="search" id = "search" value={this.state.searchTerm} onChange={(e) => this.handleChange(e)} onKeyUp={(e) => this.handleKeyUp(e)}/>
